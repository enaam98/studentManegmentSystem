                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input name="address" type="text" class="form-control"  placeholder="Enter Sepeciality">
                            </div>
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$s->id) }}" method="post">
                            @csrf
                            
                            <div class="form-group">
                                <label>First Name</label>
                                <input value="{{ $s->firstname }}" name="firstname" type="text" class="form-control"  placeholder="Enter the first name">
                            </div>
                            <div class="form-group">
                                <label>second Name</label>
                                <input value="{{ $s->secondname }}" name="secondname" type="text" class="form-control"  placeholder="Enter second name">
                            </div>
                            <div class="form-group">
                                <label>Age</label>
                                <input value="{{ $s->age }}" name="age" type="text" class="form-control"  placeholder="Enter the Age">
                            </div>
                            <div class="form-group">
                                <label>Speciality</label>
                                <input value="{{ $s->speciality }}" name="speciality" type="text" class="form-control"  placeholder="Enter Sepeciality">
                            </div>
